...
namespace :db do
  ...
  task :seed do
    Rake::Task['db:seed:grades'].invoke
    Rake::Task['db:seed:enrollment'].invoke
    Rake::Task['db:seed:salary'].invoke
    Rake::Task['db:seed:school'].invoke
  end
  
  namespace :seed do
    desc 'Populate the grade dimension.'
    task :grades do
      puts '--- add grades ---'
    ...
    desc 'Populate enrollment facts.'
    task :enrollment do
